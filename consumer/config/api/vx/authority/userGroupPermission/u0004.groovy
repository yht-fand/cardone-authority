...
//      }
		...
		def readOne = ["userGroupPermissionCode": input.userGroupPermissionCode, "object_id": "userGroupPermissionId"]
		...
		if ((dbUserGroupPermissionId != null) && !StringUtils.equals(dbUserGroupPermissionId, input.userGroupPermissionId)) {
