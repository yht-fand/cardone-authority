...
public class M0003FuncTest {
    @Value("http://localhost:${server.port:8765}${server.context-path:}/vx/authority/tokenInfo/m0003.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/authority/tokenInfo/M0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/authority/tokenInfo/M0003FuncTest.func.output.json")
