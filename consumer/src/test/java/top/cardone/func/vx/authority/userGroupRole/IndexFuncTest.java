...
public class IndexFuncTest {
    @Value("http://localhost:${server.port:8765}${server.context-path:}/vx/authority/userGroupRole/index.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/authority/userGroupRole/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/authority/userGroupRole/IndexFuncTest.func.output.json")
