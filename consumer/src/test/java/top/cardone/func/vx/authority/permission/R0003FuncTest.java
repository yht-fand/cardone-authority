...
public class R0003FuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/vx/authority/permission/r0003.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/vx/authority/permission/R0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/vx/authority/permission/R0003FuncTest.func.output.json")
