...
public class AddModalFuncTest {
    @Value("http://localhost:${server.port:8765}/cardone-authority/vx/authority/navigation/addModal.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/navigation/AddModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/navigation/AddModalFuncTest.func.output.json")
