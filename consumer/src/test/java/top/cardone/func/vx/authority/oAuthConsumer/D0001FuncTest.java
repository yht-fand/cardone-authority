...
public class D0001FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/oAuthConsumer/D0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/oAuthConsumer/D0001FuncTest.func.output.json")
