...
public class ModifyModalFuncTest {
    @Value("http://localhost:${server.port:8765}/${server.context-path:}/vx/authority/orgRole/modifyModal.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/orgRole/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/orgRole/ModifyModalFuncTest.func.output.json")
