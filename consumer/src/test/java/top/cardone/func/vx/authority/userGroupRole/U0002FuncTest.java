...
public class U0002FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/userGroupRole/U0002FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/userGroupRole/U0002FuncTest.func.output.json")
