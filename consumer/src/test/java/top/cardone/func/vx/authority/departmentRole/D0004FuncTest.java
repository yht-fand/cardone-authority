...
public class D0004FuncTest {
    @Value("http://localhost:${server.port:8765}/${server.context-path:}/vx/authority/departmentRole/d0004.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/departmentRole/D0004FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/departmentRole/D0004FuncTest.func.output.json")
