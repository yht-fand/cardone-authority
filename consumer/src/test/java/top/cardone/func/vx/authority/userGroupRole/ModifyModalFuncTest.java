...
public class ModifyModalFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/userGroupRole/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/userGroupRole/ModifyModalFuncTest.func.output.json")
