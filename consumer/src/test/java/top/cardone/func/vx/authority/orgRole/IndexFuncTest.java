...
public class IndexFuncTest {
    @Value("http://localhost:${server.port:8765}/${server.context-path:}/vx/authority/orgRole/index.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/orgRole/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/orgRole/IndexFuncTest.func.output.json")
