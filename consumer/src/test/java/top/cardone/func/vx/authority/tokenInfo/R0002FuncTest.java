...
public class R0002FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/tokenInfo/R0002FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/tokenInfo/R0002FuncTest.func.output.json")
