...
public class AddModalFuncTest {
    @Value("http://localhost:${server.port:8765}/cardone-authority/vx/authority/orgRole/addModal.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/orgRole/AddModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/orgRole/AddModalFuncTest.func.output.json")
