...
public class ModifyModalFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/userGroupUser/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/userGroupUser/ModifyModalFuncTest.func.output.json")
