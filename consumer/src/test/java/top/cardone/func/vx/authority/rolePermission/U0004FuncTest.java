...
public class U0004FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/rolePermission/U0004FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/rolePermission/U0004FuncTest.func.output.json")
