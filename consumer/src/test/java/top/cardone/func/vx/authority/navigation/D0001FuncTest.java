...
public class D0001FuncTest {
    @Value("http://localhost:${server.port:8765}/${server.context-path:}/vx/authority/navigation/d0001.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/navigation/D0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/navigation/D0001FuncTest.func.output.json")
