...
public class C0001FuncTest {
    @Value("http://localhost:${server.port:8765}/${server.context-path:}/vx/authority/departmentRole/c0001.json")
    private String funcUrl;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/departmentRole/C0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/authority/departmentRole/C0001FuncTest.func.output.json")
