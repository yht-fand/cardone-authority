 ...
 */
@Log4j2
@Component("/vx/authority/permission/r0002.json")
public class R0002Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> permissionPage = ApplicationContextHolder.getBean(PermissionService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(permissionPage.getContent(), outputTable);

        return ApplicationContextHolder.getBean(PageSupport.class).newMap(newContent, inputMap, permissionPage.getTotalElements());
    }
}