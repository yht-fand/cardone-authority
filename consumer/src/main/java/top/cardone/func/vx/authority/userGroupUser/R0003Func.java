 ...
 */
@Log4j2
@Component("/vx/authority/userGroupUser/r0003.json")
public class R0003Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> userGroupUserPage = ApplicationContextHolder.getBean(UserGroupUserService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(userGroupUserPage.getContent(), outputTable);

        return ApplicationContextHolder.getBean(PageSupport.class).newMap(newContent, inputMap, userGroupUserPage.getTotalElements());
    }
}