 ...
 */
@Log4j2
@Component("/vx/authority/navigation/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String navigationId = MapUtils.getString(inputMap, "navigationId");

        if (StringUtils.isBlank(navigationId)) {
            throw new CodeException("导航标识不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(NavigationService.class).findOneByNavigationId(newInputMap);
