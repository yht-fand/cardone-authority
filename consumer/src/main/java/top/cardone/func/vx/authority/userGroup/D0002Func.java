 ...
 */
@Log4j2
@Component("/vx/authority/userGroup/d0002.json")
public class D0002Func implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String userGroupIds = MapUtils.getString(inputMap, "userGroupIds");

        if (StringUtils.isBlank(userGroupIds)) {
            throw new CodeException("用户组标识集合不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(UserGroupService.class).deleteByIdsCache(newInputMap);
    }
}