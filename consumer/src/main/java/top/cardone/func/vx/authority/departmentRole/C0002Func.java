 ...
 */
@Log4j2
@Component("/vx/authority/departmentRole/c0002.json")
public class C0002Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(DepartmentRoleService.class).insertByNotExistsCache(newInputMap);
    }
}