package top.cardone.func.vx.authority.role;
 ...
 */
@Log4j2
@Component("/vx/authority/role/r0004.json")
public class R0004Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> rolePage = ApplicationContextHolder.getBean(RoleService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(rolePage.getContent(), outputTable);

        return ApplicationContextHolder.getBean(PageSupport.class).newMap(newContent, inputMap, rolePage.getTotalElements());
    }
}