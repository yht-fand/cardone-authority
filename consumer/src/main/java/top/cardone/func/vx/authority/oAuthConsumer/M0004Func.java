 ...
 */
@Log4j2
@Component("/vx/authority/oAuthConsumer/m0004.json")
public class M0004Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(OAuthConsumerService.class).findOne(newInputMap);
