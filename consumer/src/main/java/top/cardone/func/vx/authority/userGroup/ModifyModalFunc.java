 ...
 */
@Log4j2
@Component("/vx/authority/userGroup/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String userGroupId = MapUtils.getString(inputMap, "userGroupId");

        if (StringUtils.isBlank(userGroupId)) {
            throw new CodeException("用户组标识不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(UserGroupService.class).findOneByUserGroupId(newInputMap);
