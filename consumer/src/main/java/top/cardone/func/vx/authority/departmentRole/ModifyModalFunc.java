 ...
 */
@Log4j2
@Component("/vx/authority/departmentRole/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String departmentRoleId = MapUtils.getString(inputMap, "departmentRoleId");

        if (StringUtils.isBlank(departmentRoleId)) {
            throw new CodeException("部门与角色标识不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(DepartmentRoleService.class).findOneByDepartmentRoleId(newInputMap);
