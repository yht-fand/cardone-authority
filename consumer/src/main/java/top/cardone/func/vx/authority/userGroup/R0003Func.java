package top.cardone.func.vx.authority.userGroup;
 ...
 */
@Log4j2
@Component("/vx/authority/userGroup/r0003.json")
public class R0003Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> userGroupPage = ApplicationContextHolder.getBean(UserGroupService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(userGroupPage.getContent(), outputTable);

        return ApplicationContextHolder.getBean(PageSupport.class).newMap(newContent, inputMap, userGroupPage.getTotalElements());
    }
}