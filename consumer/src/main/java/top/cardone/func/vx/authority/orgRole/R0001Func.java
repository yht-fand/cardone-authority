 ...
 */
@Log4j2
@Component("/vx/authority/orgRole/r0001.json")
public class R0001Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> orgRolePage = ApplicationContextHolder.getBean(OrgRoleService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(orgRolePage.getContent(), outputTable);

        return ApplicationContextHolder.getBean(PageSupport.class).newMap(newContent, inputMap, orgRolePage.getTotalElements());
    }
}