 ...
 */
@Log4j2
@Component("/vx/authority/permission/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String permissionId = MapUtils.getString(inputMap, "permissionId");

        if (StringUtils.isBlank(permissionId)) {
            throw new CodeException("许可标识不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(PermissionService.class).findOneByPermissionId(newInputMap);
