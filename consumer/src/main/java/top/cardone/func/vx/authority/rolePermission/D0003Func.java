 ...
 */
@Log4j2
@Component("/vx/authority/rolePermission/d0003.json")
public class D0003Func implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String rolePermissionIds = MapUtils.getString(inputMap, "rolePermissionIds");

        if (StringUtils.isBlank(rolePermissionIds)) {
            throw new CodeException("角色与许可标识集合不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(RolePermissionService.class).deleteByIdsCache(newInputMap);
    }
}