 ...
 */
@Log4j2
@Component("/vx/authority/userGroupRole/d0003.json")
public class D0003Func implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String userGroupRoleIds = MapUtils.getString(inputMap, "userGroupRoleIds");

        if (StringUtils.isBlank(userGroupRoleIds)) {
            throw new CodeException("用户组与角色标识集合不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(UserGroupRoleService.class).deleteByIdsCache(newInputMap);
    }
}