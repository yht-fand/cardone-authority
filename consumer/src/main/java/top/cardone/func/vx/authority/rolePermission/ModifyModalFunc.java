 ...
 */
@Log4j2
@Component("/vx/authority/rolePermission/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String rolePermissionId = MapUtils.getString(inputMap, "rolePermissionId");

        if (StringUtils.isBlank(rolePermissionId)) {
            throw new CodeException("角色与许可标识不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(RolePermissionService.class).findOneByRolePermissionId(newInputMap);
