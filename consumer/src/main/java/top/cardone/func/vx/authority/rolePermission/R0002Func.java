package top.cardone.func.vx.authority.rolePermission;
 ...
 */
@Log4j2
@Component("/vx/authority/rolePermission/r0002.json")
public class R0002Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> rolePermissionPage = ApplicationContextHolder.getBean(RolePermissionService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(rolePermissionPage.getContent(), outputTable);

        return ApplicationContextHolder.getBean(PageSupport.class).newMap(newContent, inputMap, rolePermissionPage.getTotalElements());
    }
}