 ...
 */
@Log4j2
@Component("/vx/authority/userPermission/c0004.json")
public class C0004Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        return ApplicationContextHolder.getBean(UserPermissionService.class).insertByNotExistsCache(newInputMap);
    }
}
