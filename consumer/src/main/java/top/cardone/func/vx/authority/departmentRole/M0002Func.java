 ...
 */
@Log4j2
@Component("/vx/authority/departmentRole/m0002.json")
public class M0002Func implements Func1<Object, Map<String, Object>> {
    ...
    @Value("${app.root}/config/api/vx/authority/departmentRole/m0004.output.json")
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(DepartmentRoleService.class).findOne(newInputMap);
