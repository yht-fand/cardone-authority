 ...
 */
@Log4j2
@Component("/vx/authority/userGroupRole/m0003.json")
public class M0003Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(UserGroupRoleService.class).findOne(newInputMap);
