 ...
 */
@Log4j2
@Component("/vx/authority/navigation/m0001.json")
public class M0001Func implements Func1<Object, Map<String, Object>> {
    ...
    @Value("${app.root}/config/api/vx/authority/navigation/m0004.output.json")
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(NavigationService.class).findOne(newInputMap);
