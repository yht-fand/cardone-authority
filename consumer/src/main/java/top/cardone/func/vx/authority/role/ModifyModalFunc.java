 ...
 */
@Log4j2
@Component("/vx/authority/role/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String roleId = MapUtils.getString(inputMap, "roleId");

        if (StringUtils.isBlank(roleId)) {
            throw new CodeException("角色标识不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(RoleService.class).findOneByRoleId(newInputMap);
