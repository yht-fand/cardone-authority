 ...
 * 用户与角色 - 查询列表
 */
@Component("/web-api/v1/configuration/userRole/r0002.json")
public class R0002Func implements Func1<Object, Map<String, Object>> {
    @Override
    public Object func(Map<String, Object> map) {
        List<UserRoleDto> userRoleDtoList = ApplicationContextHolder.getBean(UserRoleService.class).findList(UserRoleDto.class, map);

        return this.toMapList(userRoleDtoList);
    }
