 ...
 * 用户与许可 - 查询列表
 */
@Component("/web-api/v1/configuration/userPermission/r0002.json")
public class R0002Func implements Func1<Object, Map<String, Object>> {
    @Override
    public Object func(Map<String, Object> map) {
        List<UserPermissionDto> userPermissionDtoList = ApplicationContextHolder.getBean(UserPermissionService.class).findList(UserPermissionDto.class, map);

        return this.toMapList(userPermissionDtoList);
    }
