...
public class UserGroupUserController {
    ...
    public Object c0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> {
                    ...
                    readOne.put("userGroupUserCode", MapUtils.getString(input, "userGroupUserCode"));

                    int count = ApplicationContextHolder.getBean(UserGroupUserService.class).readOne(Integer.class, readOne);

                    if (count > 0) {
                        throw new CodeException("userGroupUserCode already exists", "用户组与用户编号已经存在");
                    }

                    return ApplicationContextHolder.getBean(UserGroupUserService.class).insertByNotExistsCache(input);
                });
    }
    /** /c0001.json end **/
    ...
    public Object c0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupUserService.class).insertByNotExistsCache(input));
    }
    /** /c0002.json end **/
    ...
    public Object d0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupUserService.class).updateListCache((List) MapUtils.getObject(input, "userGroupUserIds")));
    }
    /** /d0001.json end **/
    ...
    public Object d0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupUserService.class).deleteListCache((List) MapUtils.getObject(input, "userGroupUserIds")));
    }
    /** /d0002.json end **/
    ...
    public Object m0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupUserService.class).findOne(input));
    }
    /** /m0001.json end **/
    ...
    public Object m0004Json(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return ApplicationContextHolder.getBean(WebSupport.class).importExcel(request, response,
                (Func1<Object, List<Map<String, Object>>>) inputList -> ApplicationContextHolder.getBean(UserGroupUserService.class).insertListByNotExistsCache(Lists.newArrayList(inputList)));
    }
    /** /m0004.json end **/
    ...
    public Object r0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupUserService.class).page(input));
    }
    /** /r0001.json end **/
    ...
    public Object r0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupUserService.class).findListByKeyword(input));
    }
    /** /r0002.json end **/
    ...
    public Object u0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> {
                    ...
                    readOne.put("userGroupUserCode", MapUtils.getString(input, "userGroupUserCode"));
                    readOne.put("object_id", "userGroupUserId");

                    String dbUserGroupUserId = ApplicationContextHolder.getBean(UserGroupUserService.class).readOne(String.class, readOne);

                    if (dbUserGroupUserId != null) {
                        String userGroupUserId = MapUtils.getString(input, "userGroupUserId");

                        if (!StringUtils.equals(dbUserGroupUserId, userGroupUserId)) {
                            throw new CodeException("userGroupUserCode already exists", "用户组与用户编号已经存在");
                        }
                    }

                    return ApplicationContextHolder.getBean(UserGroupUserService.class).updateCache(input);
                });
    }
    /** /u0001.json end **/
    ...
    public Object u0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupUserService.class).updateCache(input));
    }
    /** /u0002.json end **/
    ...
    public Object addModalJson(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupUserService.class).findOneByUserGroupUserId(input));
    }
    /** /addModal.json end **/
