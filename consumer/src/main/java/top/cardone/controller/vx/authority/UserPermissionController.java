...
public class UserPermissionController {
    ...
    public Object c0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> {
                    ...
                    readOne.put("userPermissionCode", MapUtils.getString(input, "userPermissionCode"));

                    int count = ApplicationContextHolder.getBean(UserPermissionService.class).readOne(Integer.class, readOne);

                    if (count > 0) {
                        throw new CodeException("userPermissionCode already exists", "用户与许可编号已经存在");
                    }

                    return ApplicationContextHolder.getBean(UserPermissionService.class).insertByNotExistsCache(input);
                });
    }
    /** /c0001.json end **/
    ...
    public Object c0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserPermissionService.class).insertByNotExistsCache(input));
    }
    /** /c0002.json end **/
    ...
    public Object d0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserPermissionService.class).updateListCache((List) MapUtils.getObject(input, "userPermissionIds")));
    }
    /** /d0001.json end **/
    ...
    public Object d0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserPermissionService.class).deleteListCache((List) MapUtils.getObject(input, "userPermissionIds")));
    }
    /** /d0002.json end **/
    ...
    public Object m0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserPermissionService.class).findOne(input));
    }
    /** /m0001.json end **/
    ...
    public Object m0004Json(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return ApplicationContextHolder.getBean(WebSupport.class).importExcel(request, response,
                (Func1<Object, List<Map<String, Object>>>) inputList -> ApplicationContextHolder.getBean(UserPermissionService.class).insertListByNotExistsCache(Lists.newArrayList(inputList)));
    }
    /** /m0004.json end **/
    ...
    public Object r0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserPermissionService.class).page(input));
    }
    /** /r0001.json end **/
    ...
    public Object r0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserPermissionService.class).findListByKeyword(input));
    }
    /** /r0002.json end **/
    ...
    public Object u0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> {
                    ...
                    readOne.put("userPermissionCode", MapUtils.getString(input, "userPermissionCode"));
                    readOne.put("object_id", "userPermissionId");

                    String dbUserPermissionId = ApplicationContextHolder.getBean(UserPermissionService.class).readOne(String.class, readOne);

                    if (dbUserPermissionId != null) {
                        String userPermissionId = MapUtils.getString(input, "userPermissionId");

                        if (!StringUtils.equals(dbUserPermissionId, userPermissionId)) {
                            throw new CodeException("userPermissionCode already exists", "用户与许可编号已经存在");
                        }
                    }

                    return ApplicationContextHolder.getBean(UserPermissionService.class).updateCache(input);
                });
    }
    /** /u0001.json end **/
    ...
    public Object u0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserPermissionService.class).updateCache(input));
    }
    /** /u0002.json end **/
    ...
    public Object addModalJson(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserPermissionService.class).findOneByUserPermissionId(input));
    }
    /** /addModal.json end **/
