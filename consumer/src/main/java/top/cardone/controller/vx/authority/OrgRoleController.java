 ...
 */
@Log4j2
@Controller("top.cardone.controller.vx.authority.OrgRoleController")
@RequestMapping("/vx/authority/orgRole")
public class OrgRoleController {
	/**
	 * /c0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/c0001.input.json")
	...
	public Object c0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(OrgRoleService.class).insertByNotExistsCache(inputMap);
	 ...
	 * /c0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/c0002.input.json")
	 ...
	 * /c0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/c0003.input.json")
	 ...
	 * /c0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/c0004.input.json")
	 ...
	 * /d0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/d0001.input.json")
	...
	public Object d0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(OrgRoleService.class).deleteByIdsCache(inputMap);
	 ...
	 * /d0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/d0002.input.json")
	 ...
	 * /d0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/d0003.input.json")
	 ...
	 * /m0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/m0001.input.json")
	...
	public Object m0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(OrgRoleService.class).findOne(inputMap);
	 ...
	 * /m0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/m0002.input.json")
	 ...
	 * /m0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/m0003.input.json")
	 ...
	 * /r0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/r0001.input.json")
	private String r0001InputJson;

	@Value("${app.root}/config/api/vx/authority/orgRole/r0001.output.json")
	...
	public Object r0001Json(HttpServletRequest request) {
		...
		Page<Map<String, Object>> page = ApplicationContextHolder.getBean(OrgRoleService.class).page(inputMap);
	 ...
	 * /r0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/r0002.input.json")
	private String r0002InputJson;

	@Value("${app.root}/config/api/vx/authority/orgRole/r0002.output.json")
	 ...
	 * /r0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/r0003.input.json")
	private String r0003InputJson;

	@Value("${app.root}/config/api/vx/authority/orgRole/r0003.output.json")
	 ...
	 * /r0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/r0004.input.json")
	private String r0004InputJson;

	@Value("${app.root}/config/api/vx/authority/orgRole/r0004.output.json")
	 ...
	 * /u0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/u0001.input.json")
	...
	public Object u0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(OrgRoleService.class).updateCache(inputMap);
	 ...
	 * /u0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/u0002.input.json")
	 ...
	 * /u0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/u0003.input.json")
	 ...
	 * /u0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/u0004.input.json")
	 ...
	 **xx/
	@Value("${app.root}/config/api/vx/authority/orgRole/modifyModal.input.json")
	private String modifyModalInputJson;

	@Value("${app.root}/config/api/vx/authority/orgRole/modifyModal.output.json")
	...
	public Object modifyModalJson(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(OrgRoleService.class).findOneByOrgRoleId(inputMap.get("orgRoleId"));
