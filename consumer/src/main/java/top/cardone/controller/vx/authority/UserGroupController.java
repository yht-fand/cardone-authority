...
public class UserGroupController {
	...
	public Object m0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(UserGroupService.class).findOne(inputMap);
	...
	public Object modifyModalJson(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(UserGroupService.class).findOneByUserGroupId(inputMap.get("userGroupId"));
