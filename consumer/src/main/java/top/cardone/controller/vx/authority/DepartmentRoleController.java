...
import top.cardone.authority.service.DepartmentRoleService;
 ...
 */
@Log4j2
@Controller("top.cardone.controller.vx.authority.DepartmentRoleController")
@RequestMapping("/vx/authority/departmentRole")
public class DepartmentRoleController {
	/**
	 * /c0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/c0001.input.json")
	...
	public Object c0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(DepartmentRoleService.class).insertByNotExistsCache(inputMap);
	 ...
	 * /c0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/c0002.input.json")
	 ...
	 * /c0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/c0003.input.json")
	 ...
	 * /c0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/c0004.input.json")
	 ...
	 * /d0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/d0001.input.json")
	...
	public Object d0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(DepartmentRoleService.class).deleteByIdsCache(inputMap);
	 ...
	 * /d0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/d0002.input.json")
	 ...
	 * /d0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/d0003.input.json")
	 ...
	 * /d0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/d0004.input.json")
	 ...
	 * /m0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/m0001.input.json")
	...
	public Object m0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(DepartmentRoleService.class).findOne(inputMap);
	 ...
	 * /m0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/m0002.input.json")
	 ...
	 * /m0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/m0003.input.json")
	 ...
	 * /m0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/m0004.input.json")
	 ...
	 * /r0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/r0001.input.json")
	private String r0001InputJson;

	@Value("${app.root}/config/api/vx/authority/departmentRole/r0001.output.json")
	...
	public Object r0001Json(HttpServletRequest request) {
		...
		Page<Map<String, Object>> page = ApplicationContextHolder.getBean(DepartmentRoleService.class).page(inputMap);
	 ...
	 * /r0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/r0002.input.json")
	private String r0002InputJson;

	@Value("${app.root}/config/api/vx/authority/departmentRole/r0002.output.json")
	 ...
	 * /r0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/r0003.input.json")
	private String r0003InputJson;

	@Value("${app.root}/config/api/vx/authority/departmentRole/r0003.output.json")
	 ...
	 * /r0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/r0004.input.json")
	private String r0004InputJson;

	@Value("${app.root}/config/api/vx/authority/departmentRole/r0004.output.json")
	 ...
	 * /u0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/u0001.input.json")
	...
	public Object u0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(DepartmentRoleService.class).updateCache(inputMap);
	 ...
	 * /u0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/u0002.input.json")
	 ...
	 * /u0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/u0003.input.json")
	 ...
	 * /u0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/u0004.input.json")
	 ...
	 **xx/
	@Value("${app.root}/config/api/vx/authority/departmentRole/modifyModal.input.json")
	private String modifyModalInputJson;

	@Value("${app.root}/config/api/vx/authority/departmentRole/modifyModal.output.json")
	...
	public Object modifyModalJson(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(DepartmentRoleService.class).findOneByDepartmentRoleId(inputMap.get("departmentRoleId"));
