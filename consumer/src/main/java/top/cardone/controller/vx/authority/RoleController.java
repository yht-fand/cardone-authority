...
public class RoleController {
    ...
    public Object c0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> {
                    ...
                    readOne.put("roleCode", MapUtils.getString(input, "roleCode"));

                    int count = ApplicationContextHolder.getBean(RoleService.class).readOne(Integer.class, readOne);

                    if (count > 0) {
                        throw new CodeException("roleCode already exists", "角色编号已经存在");
                    }

                    return ApplicationContextHolder.getBean(RoleService.class).insertByNotExistsCache(input);
                });
    }
    /** /c0001.json end **/
    ...
    public Object c0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RoleService.class).insertByNotExistsCache(input));
    }
    /** /c0002.json end **/
    ...
    public Object d0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RoleService.class).updateListCache((List) MapUtils.getObject(input, "roleIds")));
    }
    /** /d0001.json end **/
    ...
    public Object d0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RoleService.class).deleteListCache((List) MapUtils.getObject(input, "roleIds")));
    }
    /** /d0002.json end **/
    ...
    public Object m0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RoleService.class).findOne(input));
    }
    /** /m0001.json end **/
    ...
    public Object m0004Json(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return ApplicationContextHolder.getBean(WebSupport.class).importExcel(request, response,
                (Func1<Object, List<Map<String, Object>>>) inputList -> ApplicationContextHolder.getBean(RoleService.class).insertListByNotExistsCache(Lists.newArrayList(inputList)));
    }
    /** /m0004.json end **/
    ...
    public Object r0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RoleService.class).page(input));
    }
    /** /r0001.json end **/
    ...
    public Object r0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RoleService.class).findListByKeyword(input));
    }
    /** /r0002.json end **/
    ...
    public Object u0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> {
                    ...
                    readOne.put("roleCode", MapUtils.getString(input, "roleCode"));
                    readOne.put("object_id", "roleId");

                    String dbRoleId = ApplicationContextHolder.getBean(RoleService.class).readOne(String.class, readOne);

                    if (dbRoleId != null) {
                        String roleId = MapUtils.getString(input, "roleId");

                        if (!StringUtils.equals(dbRoleId, roleId)) {
                            throw new CodeException("roleCode already exists", "角色编号已经存在");
                        }
                    }

                    return ApplicationContextHolder.getBean(RoleService.class).updateCache(input);
                });
    }
    /** /u0001.json end **/
    ...
    public Object u0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RoleService.class).updateCache(input));
    }
    /** /u0002.json end **/
    ...
    public Object addModalJson(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RoleService.class).findOneByRoleId(input));
    }
    /** /addModal.json end **/
