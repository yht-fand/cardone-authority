...
public class RolePermissionController {
	...
	public Object m0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(RolePermissionService.class).findOne(inputMap);
	...
	public Object modifyModalJson(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(RolePermissionService.class).findOneByRolePermissionId(inputMap.get("rolePermissionId"));
