...
public class RolePermissionController {
    ...
    public Object d0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RolePermissionService.class).updateListCache((List) MapUtils.getObject(input, "rolePermissionIds")));
    }
    /** /d0001.json end **/
    ...
    public Object d0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(RolePermissionService.class).deleteListCache((List) MapUtils.getObject(input, "rolePermissionIds")));
    }
    /** /d0002.json end **/
