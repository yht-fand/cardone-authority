...
public class UserGroupPermissionController {
    ...
    public Object c0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> {
                    ...
                    readOne.put("userGroupPermissionCode", MapUtils.getString(input, "userGroupPermissionCode"));

                    int count = ApplicationContextHolder.getBean(UserGroupPermissionService.class).readOne(Integer.class, readOne);

                    if (count > 0) {
                        throw new CodeException("userGroupPermissionCode already exists", "用户组与许可编号已经存在");
                    }

                    return ApplicationContextHolder.getBean(UserGroupPermissionService.class).insertByNotExistsCache(input);
                });
    }
    /** /c0001.json end **/
    ...
    public Object c0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupPermissionService.class).insertByNotExistsCache(input));
    }
    /** /c0002.json end **/
    ...
    public Object d0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupPermissionService.class).updateListCache((List) MapUtils.getObject(input, "userGroupPermissionIds")));
    }
    /** /d0001.json end **/
    ...
    public Object d0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupPermissionService.class).deleteListCache((List) MapUtils.getObject(input, "userGroupPermissionIds")));
    }
    /** /d0002.json end **/
    ...
    public Object m0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupPermissionService.class).findOne(input));
    }
    /** /m0001.json end **/
    ...
    public Object m0004Json(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return ApplicationContextHolder.getBean(WebSupport.class).importExcel(request, response,
                (Func1<Object, List<Map<String, Object>>>) inputList -> ApplicationContextHolder.getBean(UserGroupPermissionService.class).insertListByNotExistsCache(Lists.newArrayList(inputList)));
    }
    /** /m0004.json end **/
    ...
    public Object r0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupPermissionService.class).page(input));
    }
    /** /r0001.json end **/
    ...
    public Object r0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupPermissionService.class).findListByKeyword(input));
    }
    /** /r0002.json end **/
    ...
    public Object u0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> {
                    ...
                    readOne.put("userGroupPermissionCode", MapUtils.getString(input, "userGroupPermissionCode"));
                    readOne.put("object_id", "userGroupPermissionId");

                    String dbUserGroupPermissionId = ApplicationContextHolder.getBean(UserGroupPermissionService.class).readOne(String.class, readOne);

                    if (dbUserGroupPermissionId != null) {
                        String userGroupPermissionId = MapUtils.getString(input, "userGroupPermissionId");

                        if (!StringUtils.equals(dbUserGroupPermissionId, userGroupPermissionId)) {
                            throw new CodeException("userGroupPermissionCode already exists", "用户组与许可编号已经存在");
                        }
                    }

                    return ApplicationContextHolder.getBean(UserGroupPermissionService.class).updateCache(input);
                });
    }
    /** /u0001.json end **/
    ...
    public Object u0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupPermissionService.class).updateCache(input));
    }
    /** /u0002.json end **/
    ...
    public Object addModalJson(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(UserGroupPermissionService.class).findOneByUserGroupPermissionId(input));
    }
    /** /addModal.json end **/
