...
public class OAuthConsumerController {
	...
	public Object m0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(OAuthConsumerService.class).findOne(inputMap);
	...
	public Object modifyModalJson(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(OAuthConsumerService.class).findOneByOAuthConsumerId(inputMap.get("oAuthConsumerId"));
