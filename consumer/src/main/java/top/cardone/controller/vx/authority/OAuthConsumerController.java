...
public class OAuthConsumerController {
    ...
    public Object c0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> {
                    ...
                    readOne.put("oAuthConsumerCode", MapUtils.getString(input, "oAuthConsumerCode"));

                    int count = ApplicationContextHolder.getBean(OAuthConsumerService.class).readOne(Integer.class, readOne);

                    if (count > 0) {
                        throw new CodeException("oAuthConsumerCode already exists", "授权消费编号已经存在");
                    }

                    return ApplicationContextHolder.getBean(OAuthConsumerService.class).insertByNotExistsCache(input);
                });
    }
    /** /c0001.json end **/
    ...
    public Object c0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(OAuthConsumerService.class).insertByNotExistsCache(input));
    }
    /** /c0002.json end **/
    ...
    public Object d0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(OAuthConsumerService.class).updateListCache((List) MapUtils.getObject(input, "oAuthConsumerIds")));
    }
    /** /d0001.json end **/
    ...
    public Object d0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(OAuthConsumerService.class).deleteListCache((List) MapUtils.getObject(input, "oAuthConsumerIds")));
    }
    /** /d0002.json end **/
    ...
    public Object m0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(OAuthConsumerService.class).findOne(input));
    }
    /** /m0001.json end **/
    ...
    public Object m0004Json(HttpServletRequest request, HttpServletResponse response) throws Exception {
        return ApplicationContextHolder.getBean(WebSupport.class).importExcel(request, response,
                (Func1<Object, List<Map<String, Object>>>) inputList -> ApplicationContextHolder.getBean(OAuthConsumerService.class).insertListByNotExistsCache(Lists.newArrayList(inputList)));
    }
    /** /m0004.json end **/
    ...
    public Object r0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(OAuthConsumerService.class).page(input));
    }
    /** /r0001.json end **/
    ...
    public Object r0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(OAuthConsumerService.class).findListByKeyword(input));
    }
    /** /r0002.json end **/
    ...
    public Object u0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> {
                    ...
                    readOne.put("oAuthConsumerCode", MapUtils.getString(input, "oAuthConsumerCode"));
                    readOne.put("object_id", "oAuthConsumerId");

                    String dbOAuthConsumerId = ApplicationContextHolder.getBean(OAuthConsumerService.class).readOne(String.class, readOne);

                    if (dbOAuthConsumerId != null) {
                        String oAuthConsumerId = MapUtils.getString(input, "oAuthConsumerId");

                        if (!StringUtils.equals(dbOAuthConsumerId, oAuthConsumerId)) {
                            throw new CodeException("oAuthConsumerCode already exists", "授权消费编号已经存在");
                        }
                    }

                    return ApplicationContextHolder.getBean(OAuthConsumerService.class).updateCache(input);
                });
    }
    /** /u0001.json end **/
    ...
    public Object u0002Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(OAuthConsumerService.class).updateCache(input));
    }
    /** /u0002.json end **/
    ...
    public Object addModalJson(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Map<String, Object>>) input -> ApplicationContextHolder.getBean(OAuthConsumerService.class).findOneByOAuthConsumerId(input));
    }
    /** /addModal.json end **/
