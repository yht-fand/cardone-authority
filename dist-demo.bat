...
xcopy provider\target\cardone-authority-provider-*.jar dist\demo\provider /Y/C/R/I
...
xcopy consumer\target\cardone-authority-consumer-*.jar dist\demo\consumer /Y/C/R/I
pause