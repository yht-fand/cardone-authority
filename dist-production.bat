...
xcopy provider\target\cardone-authority-provider-*.jar dist\production\provider /Y/C/R/I
...
xcopy consumer\target\cardone-authority-consumer-*.jar dist\production\consumer /Y/C/R/I
pause