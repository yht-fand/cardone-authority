...
public class ReadListPermissionCodeFuncTest {
    @Test
    public void func() throws Exception {
        Set<String> sets = (Set<String>) ApplicationContextHolder.getBean(Func1.class, "readListPermissionCodeFunc").func("admin");
