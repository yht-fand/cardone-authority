...
AND EXISTS(SELECT s.* FROM `c1_dictionary` s WHERE s.`DICTIONARY_TYPE_CODE` = 'roleType' AND LOCATE(:typeName, s.`NAME`))
</#if>
...
AND (LOCATE(:name, t.`role_CODE`) OR LOCATE(:name, t.`NAME`))
</#if>
