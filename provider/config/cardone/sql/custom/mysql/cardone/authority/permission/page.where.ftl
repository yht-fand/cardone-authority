...
AND EXISTS(SELECT s.* FROM `c1_dictionary` s WHERE s.`DICTIONARY_TYPE_CODE` = 'permissionType' AND LOCATE(:typeName, s.`NAME`))
</#if>
...
AND (LOCATE(:name, t.`permission_CODE`) OR LOCATE(:name, t.`NAME`))
</#if>
