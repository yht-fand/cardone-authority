...
<#if (insert_departmentRoleId??) && (insert_departmentRoleId_value??)>
${prefixName} `DEPARTMENT_ROLE_ID`
<#assign prefixName = ','>
</#if>
...
<#if (insert_departmentRoleId??) && (insert_departmentRoleId_value??)>
${prefixName} :insert_departmentRoleId_value
<#assign prefixName = ','>
</#if>
<#if (insert_endDate??) && (insert_endDate_value??)>
...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM c1_department_role E
...
<#if (where_and_eq_departmentRoleId??)>
<#if (where_and_eq_departmentRoleId_value??)>
${prefixName} E.DEPARTMENT_ROLE_ID = :where_and_eq_departmentRoleId_value
<#else>
${prefixName} E.DEPARTMENT_ROLE_ID IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
