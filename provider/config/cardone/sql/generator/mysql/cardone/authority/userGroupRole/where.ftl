...
<#if (where_and_nq_userGroupCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_userGroupCode_value??)>
${prefixName} `USER_GROUP_CODE` <> :where_and_nq_userGroupCode_value
<#else>
${prefixName} `USER_GROUP_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_userGroupCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_userGroupCode_value??)>
${prefixName} `USER_GROUP_CODE` <> :where_and_like_userGroupCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_userGroupCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_userGroupCode_value??)>
${prefixName} `USER_GROUP_CODE` = :where_or_eq_userGroupCode_value
<#else>
${prefixName} `USER_GROUP_CODE` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_userGroupCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_userGroupCode_value??)>
${prefixName} `USER_GROUP_CODE` <> :where_or_nq_userGroupCode_value
<#else>
${prefixName} `USER_GROUP_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_userGroupCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_userGroupCode_value??)>
${prefixName} `USER_GROUP_CODE` like :where_or_like_userGroupCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
<#if (where_and_nq_userGroupRoleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_userGroupRoleId_value??)>
${prefixName} `USER_GROUP_ROLE_ID` <> :where_and_nq_userGroupRoleId_value
<#else>
${prefixName} `USER_GROUP_ROLE_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_userGroupRoleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_userGroupRoleId_value??)>
${prefixName} `USER_GROUP_ROLE_ID` <> :where_and_like_userGroupRoleId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_userGroupRoleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_userGroupRoleId_value??)>
${prefixName} `USER_GROUP_ROLE_ID` = :where_or_eq_userGroupRoleId_value
<#else>
${prefixName} `USER_GROUP_ROLE_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_userGroupRoleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_userGroupRoleId_value??)>
${prefixName} `USER_GROUP_ROLE_ID` <> :where_or_nq_userGroupRoleId_value
<#else>
${prefixName} `USER_GROUP_ROLE_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_userGroupRoleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_userGroupRoleId_value??)>
${prefixName} `USER_GROUP_ROLE_ID` like :where_or_like_userGroupRoleId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
