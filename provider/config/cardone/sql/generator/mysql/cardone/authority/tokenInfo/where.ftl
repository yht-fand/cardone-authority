...
<#if (where_and_nq_clientId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_clientId_value??)>
${prefixName} `CLIENT_ID` <> :where_and_nq_clientId_value
<#else>
${prefixName} `CLIENT_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_clientId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_clientId_value??)>
${prefixName} `CLIENT_ID` <> :where_and_like_clientId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_clientId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_clientId_value??)>
${prefixName} `CLIENT_ID` = :where_or_eq_clientId_value
<#else>
${prefixName} `CLIENT_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_clientId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_clientId_value??)>
${prefixName} `CLIENT_ID` <> :where_or_nq_clientId_value
<#else>
${prefixName} `CLIENT_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_clientId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_clientId_value??)>
${prefixName} `CLIENT_ID` like :where_or_like_clientId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
<#if (where_and_nq_scope??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_scope_value??)>
${prefixName} `SCOPE` <> :where_and_nq_scope_value
<#else>
${prefixName} `SCOPE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_scope??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_scope_value??)>
${prefixName} `SCOPE` <> :where_and_like_scope_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_scope??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_scope_value??)>
${prefixName} `SCOPE` = :where_or_eq_scope_value
<#else>
${prefixName} `SCOPE` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_scope??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_scope_value??)>
${prefixName} `SCOPE` <> :where_or_nq_scope_value
<#else>
${prefixName} `SCOPE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_scope??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_scope_value??)>
${prefixName} `SCOPE` like :where_or_like_scope_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
<#if (where_and_nq_tokenInfoCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_tokenInfoCode_value??)>
${prefixName} `TOKEN_INFO_CODE` <> :where_and_nq_tokenInfoCode_value
<#else>
${prefixName} `TOKEN_INFO_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_tokenInfoCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_tokenInfoCode_value??)>
${prefixName} `TOKEN_INFO_CODE` <> :where_and_like_tokenInfoCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_tokenInfoCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_tokenInfoCode_value??)>
${prefixName} `TOKEN_INFO_CODE` = :where_or_eq_tokenInfoCode_value
<#else>
${prefixName} `TOKEN_INFO_CODE` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_tokenInfoCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_tokenInfoCode_value??)>
${prefixName} `TOKEN_INFO_CODE` <> :where_or_nq_tokenInfoCode_value
<#else>
${prefixName} `TOKEN_INFO_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_tokenInfoCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_tokenInfoCode_value??)>
${prefixName} `TOKEN_INFO_CODE` like :where_or_like_tokenInfoCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
<#if (where_and_nq_tokenInfoId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_tokenInfoId_value??)>
${prefixName} `TOKEN_INFO_ID` <> :where_and_nq_tokenInfoId_value
<#else>
${prefixName} `TOKEN_INFO_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_tokenInfoId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_tokenInfoId_value??)>
${prefixName} `TOKEN_INFO_ID` <> :where_and_like_tokenInfoId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_tokenInfoId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_tokenInfoId_value??)>
${prefixName} `TOKEN_INFO_ID` = :where_or_eq_tokenInfoId_value
<#else>
${prefixName} `TOKEN_INFO_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_tokenInfoId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_tokenInfoId_value??)>
${prefixName} `TOKEN_INFO_ID` <> :where_or_nq_tokenInfoId_value
<#else>
${prefixName} `TOKEN_INFO_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_tokenInfoId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_tokenInfoId_value??)>
${prefixName} `TOKEN_INFO_ID` like :where_or_like_tokenInfoId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
