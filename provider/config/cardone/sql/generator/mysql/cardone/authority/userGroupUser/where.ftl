...
<#if (where_and_eq_userGroupUserId??)>
<#if (where_and_eq_userGroupUserId_value??)>
${prefixName} `USER_GROUP_USER_ID` = :where_and_eq_userGroupUserId_value
<#else>
${prefixName} `USER_GROUP_USER_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_nq_userGroupUserId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_userGroupUserId_value??)>
${prefixName} `USER_GROUP_USER_ID` <> :where_and_nq_userGroupUserId_value
<#else>
${prefixName} `USER_GROUP_USER_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_userGroupUserId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_userGroupUserId_value??)>
${prefixName} `USER_GROUP_USER_ID` <> :where_and_like_userGroupUserId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_userGroupUserId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_userGroupUserId_value??)>
${prefixName} `USER_GROUP_USER_ID` = :where_or_eq_userGroupUserId_value
<#else>
${prefixName} `USER_GROUP_USER_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_userGroupUserId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_userGroupUserId_value??)>
${prefixName} `USER_GROUP_USER_ID` <> :where_or_nq_userGroupUserId_value
<#else>
${prefixName} `USER_GROUP_USER_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_userGroupUserId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_userGroupUserId_value??)>
${prefixName} `USER_GROUP_USER_ID` like :where_or_like_userGroupUserId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
