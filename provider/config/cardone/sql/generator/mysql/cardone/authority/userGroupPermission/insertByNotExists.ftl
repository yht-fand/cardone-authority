...
<#if (insert_userGroupCode??) && (insert_userGroupCode_value??)>
${prefixName} :insert_userGroupCode_value
<#assign prefixName = ','>
</#if>
<#if (insert_userGroupPermissionId??) && (insert_userGroupPermissionId_value??)>
${prefixName} :insert_userGroupPermissionId_value
<#assign prefixName = ','>
</#if>
<#if (insert_version??) && (insert_version_value??)>
...
${prefixName} E.USER_GROUP_CODE = :where_and_eq_userGroupCode_value
<#else>
${prefixName} E.USER_GROUP_CODE IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_eq_userGroupPermissionId??)>
<#if (where_and_eq_userGroupPermissionId_value??)>
${prefixName} E.USER_GROUP_PERMISSION_ID = :where_and_eq_userGroupPermissionId_value
<#else>
${prefixName} E.USER_GROUP_PERMISSION_ID IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
