...
<#if (where_and_nq_permissionCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_permissionCode_value??)>
${prefixName} `PERMISSION_CODE` <> :where_and_nq_permissionCode_value
<#else>
${prefixName} `PERMISSION_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_permissionCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_permissionCode_value??)>
${prefixName} `PERMISSION_CODE` <> :where_and_like_permissionCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_permissionCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_permissionCode_value??)>
${prefixName} `PERMISSION_CODE` = :where_or_eq_permissionCode_value
<#else>
${prefixName} `PERMISSION_CODE` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_permissionCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_permissionCode_value??)>
${prefixName} `PERMISSION_CODE` <> :where_or_nq_permissionCode_value
<#else>
${prefixName} `PERMISSION_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_permissionCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_permissionCode_value??)>
${prefixName} `PERMISSION_CODE` like :where_or_like_permissionCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
<#if (where_and_nq_roleCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_roleCode_value??)>
${prefixName} `ROLE_CODE` <> :where_and_nq_roleCode_value
<#else>
${prefixName} `ROLE_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_roleCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_roleCode_value??)>
${prefixName} `ROLE_CODE` <> :where_and_like_roleCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_roleCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_roleCode_value??)>
${prefixName} `ROLE_CODE` = :where_or_eq_roleCode_value
<#else>
${prefixName} `ROLE_CODE` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_roleCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_roleCode_value??)>
${prefixName} `ROLE_CODE` <> :where_or_nq_roleCode_value
<#else>
${prefixName} `ROLE_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_roleCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_roleCode_value??)>
${prefixName} `ROLE_CODE` like :where_or_like_roleCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
<#if (where_and_eq_rolePermissionId??)>
<#if (where_and_eq_rolePermissionId_value??)>
${prefixName} `ROLE_PERMISSION_ID` = :where_and_eq_rolePermissionId_value
<#else>
${prefixName} `ROLE_PERMISSION_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_nq_rolePermissionId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_rolePermissionId_value??)>
${prefixName} `ROLE_PERMISSION_ID` <> :where_and_nq_rolePermissionId_value
<#else>
${prefixName} `ROLE_PERMISSION_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_rolePermissionId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_rolePermissionId_value??)>
${prefixName} `ROLE_PERMISSION_ID` <> :where_and_like_rolePermissionId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_rolePermissionId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_rolePermissionId_value??)>
${prefixName} `ROLE_PERMISSION_ID` = :where_or_eq_rolePermissionId_value
<#else>
${prefixName} `ROLE_PERMISSION_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_rolePermissionId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_rolePermissionId_value??)>
${prefixName} `ROLE_PERMISSION_ID` <> :where_or_nq_rolePermissionId_value
<#else>
${prefixName} `ROLE_PERMISSION_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_rolePermissionId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_rolePermissionId_value??)>
${prefixName} `ROLE_PERMISSION_ID` like :where_or_like_rolePermissionId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
