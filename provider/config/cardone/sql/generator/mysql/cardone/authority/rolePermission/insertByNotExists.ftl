...
<#if (insert_rolePermissionId??) && (insert_rolePermissionId_value??)>
${prefixName} :insert_rolePermissionId_value
<#assign prefixName = ','>
</#if>
<#if (insert_siteCode??) && (insert_siteCode_value??)>
...
${prefixName} E.ROLE_PERMISSION_ID = :where_and_eq_rolePermissionId_value
<#else>
${prefixName} E.ROLE_PERMISSION_ID IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
