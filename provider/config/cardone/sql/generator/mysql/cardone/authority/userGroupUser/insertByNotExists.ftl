...
<#if (insert_userGroupUserId??) && (insert_userGroupUserId_value??)>
${prefixName} :insert_userGroupUserId_value
<#assign prefixName = ','>
</#if>
<#if (insert_version??) && (insert_version_value??)>
...
${prefixName} E.USER_GROUP_USER_ID = :where_and_eq_userGroupUserId_value
<#else>
${prefixName} E.USER_GROUP_USER_ID IS NULL
</#if>
<#assign prefixName = 'AND'>
</#if>
