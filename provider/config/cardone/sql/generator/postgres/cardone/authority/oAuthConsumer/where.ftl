...
${prefixName?string('WHERE ', 'AND ')}"client_secret" = :where_and_eq_clientSecret_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("client_secret" IS NULL OR "client_secret" = '')
</#if>
<#assign prefixName = false>
</#if>
...
${prefixName?string('WHERE ', 'AND ')}"oauth_consumer_id" = :where_and_eq_oauthConsumerId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("oauth_consumer_id" IS NULL OR "oauth_consumer_id" = '')
</#if>
<#assign prefixName = false>
</#if>
