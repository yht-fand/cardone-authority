...
${prefixName?string('WHERE ', 'AND ')}"user_permission_id" = :where_and_eq_userPermissionId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("user_permission_id" IS NULL OR "user_permission_id" = '')
</#if>
<#assign prefixName = false>
</#if>
