...
<#if (update_clientId??)>
${prefixName?string('', ', ')}"client_id" = :update_clientId_value
<#assign prefixName = false>
</#if>
...
<#if (update_scope??)>
${prefixName?string('', ', ')}"scope" = :update_scope_value
<#assign prefixName = false>
</#if>
<#if (update_siteCode??)>
...
${prefixName?string('', ', ')}"token_info_code" = :update_tokenInfoCode_value
<#assign prefixName = false>
</#if>
<#if (update_tokenInfoId??)>
${prefixName?string('', ', ')}"token_info_id" = :update_tokenInfoId_value
<#assign prefixName = false>
</#if>
<#if (update_userCode??)>
