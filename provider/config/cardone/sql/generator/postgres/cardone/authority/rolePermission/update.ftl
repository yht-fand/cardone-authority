...
<#if (update_roleCode??)>
${prefixName?string('SET ', ', ')}"role_code" = :update_roleCode_value
<#assign prefixName = false>
</#if>
<#if (update_roleId??)>
${prefixName?string('SET ', ', ')}"role_id" = :update_roleId_value
<#assign prefixName = false>
</#if>
<#if (update_rolePermissionId??)>
${prefixName?string('SET ', ', ')}"role_permission_id" = :update_rolePermissionId_value
<#assign prefixName = false>
</#if>
<#if (update_siteCode??)>
