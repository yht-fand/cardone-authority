...
<#else>
${prefixName?string('WHERE ', 'AND ')}"client_id" IS NULL
</#if>
<#assign prefixName = false>
</#if>
...
<#else>
${prefixName?string('WHERE ', 'AND ')}"scope" IS NULL
</#if>
<#assign prefixName = false>
</#if>
...
<#else>
${prefixName?string('WHERE ', 'AND ')}"token_info_code" IS NULL
</#if>
<#assign prefixName = false>
</#if>
...
<#else>
${prefixName?string('WHERE ', 'AND ')}"token_info_id" IS NULL
</#if>
<#assign prefixName = false>
</#if>
