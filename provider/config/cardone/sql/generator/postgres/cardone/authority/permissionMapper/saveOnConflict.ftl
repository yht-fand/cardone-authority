...
${prefixName?string('', ', ')}"mapper_code" = :update_mapperCode_value
<#assign prefixName = false>
</#if>
<#if (update_orderBy??)>
...
${prefixName?string('', ', ')}"permission_code" = :update_permissionCode_value
<#assign prefixName = false>
</#if>
<#if (update_permissionId??)>
${prefixName?string('', ', ')}"permission_id" = :update_permissionId_value
<#assign prefixName = false>
</#if>
<#if (update_permissionMapperId??)>
${prefixName?string('', ', ')}"permission_mapper_id" = :update_permissionMapperId_value
<#assign prefixName = false>
</#if>
