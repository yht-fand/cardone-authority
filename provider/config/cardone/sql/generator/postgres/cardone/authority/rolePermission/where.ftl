...
${prefixName?string('WHERE ', 'AND ')}"role_permission_id" = :where_and_eq_rolePermissionId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("role_permission_id" IS NULL OR "role_permission_id" = '')
</#if>
<#assign prefixName = false>
</#if>
