...
${prefixName?string('WHERE ', 'AND ')}"user_group_permission_id" = :where_and_eq_userGroupPermissionId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}("user_group_permission_id" IS NULL OR "user_group_permission_id" = '')
</#if>
<#assign prefixName = false>
</#if>
