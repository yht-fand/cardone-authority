...
<#else>
${prefixName?string('WHERE ', 'AND ')}"permission_code" IS NULL
</#if>
<#assign prefixName = false>
</#if>
...
<#else>
${prefixName?string('WHERE ', 'AND ')}"user_group_code" IS NULL
</#if>
<#assign prefixName = false>
</#if>
...
<#else>
${prefixName?string('WHERE ', 'AND ')}"user_group_permission_id" IS NULL
</#if>
<#assign prefixName = false>
</#if>
