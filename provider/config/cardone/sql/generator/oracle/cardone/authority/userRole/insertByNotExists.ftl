...
<#if (insert_userRoleId??) && (insert_userRoleId_value??)>
${prefixName?string('  ', ', ')}USER_ROLE_ID
<#assign prefixName = false>
</#if>
...
<#if (insert_userRoleId??) && (insert_userRoleId_value??)>
${prefixName?string('  ', ', ')}:insert_userRoleId_value
<#assign prefixName = false>
</#if>
<#if (insert_version??) && (insert_version_value??)>
...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM C1_USER_ROLE E
<#assign prefixName = true>
...
${prefixName?string('WHERE ', 'AND ')}E.USER_ROLE_ID = :where_and_eq_userRoleId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.USER_ROLE_ID IS NULL OR E.USER_ROLE_ID = '')
</#if>
<#assign prefixName = false>
</#if>
