...
${prefixName?string('', 'AND ')} :index_rolePermissionId_value AS ROLE_PERMISSION_ID
<#assign prefixName = false>
</#if>
<#if (index_siteCode??)>
...
<#if (index_rolePermissionId??)>
${prefixName?string('', ', ')}A.ROLE_PERMISSION_ID = B.ROLE_PERMISSION_ID
<#assign prefixName = false>
</#if>
<#if (index_siteCode??)>
...
<#if (update_rolePermissionId??)>
${prefixName?string('', ', ')}A.ROLE_PERMISSION_ID = :update_rolePermissionId_value
<#assign prefixName = false>
</#if>
<#if (update_siteCode??)>
