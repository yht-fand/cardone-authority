...
<#if (insert_userPermissionId??) && (insert_userPermissionId_value??)>
...
<#if (insert_userPermissionId??) && (insert_userPermissionId_value??)>
${prefixName?string('  ', ', ')}:insert_userPermissionId_value
<#assign prefixName = false>
</#if>
<#if (insert_version??) && (insert_version_value??)>
...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM C1_USER_PERMISSION E
<#assign prefixName = true>
...
${prefixName?string('WHERE ', 'AND ')}E.USER_PERMISSION_ID = :where_and_eq_userPermissionId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.USER_PERMISSION_ID IS NULL OR E.USER_PERMISSION_ID = '')
</#if>
<#assign prefixName = false>
</#if>
