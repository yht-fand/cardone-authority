...
<#if (insert_userGroupPermissionId??) && (insert_userGroupPermissionId_value??)>
${prefixName?string('  ', ', ')}USER_GROUP_PERMISSION_ID
<#assign prefixName = false>
</#if>
...
<#if (insert_userGroupPermissionId??) && (insert_userGroupPermissionId_value??)>
${prefixName?string('  ', ', ')}:insert_userGroupPermissionId_value
<#assign prefixName = false>
</#if>
<#if (insert_version??) && (insert_version_value??)>
...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM C1_USER_GROUP_PERMISSION E
<#assign prefixName = true>
...
${prefixName?string('WHERE ', 'AND ')}E.PERMISSION_CODE = :where_and_eq_permissionCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.PERMISSION_CODE IS NULL OR E.PERMISSION_CODE = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_permissionId??)>
<#if (where_and_eq_permissionId_value??)>
${prefixName?string('WHERE ', 'AND ')}E.PERMISSION_ID = :where_and_eq_permissionId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.PERMISSION_ID IS NULL OR E.PERMISSION_ID = '')
</#if>
<#assign prefixName = false>
</#if>
...
${prefixName?string('WHERE ', 'AND ')}E.USER_GROUP_CODE = :where_and_eq_userGroupCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.USER_GROUP_CODE IS NULL OR E.USER_GROUP_CODE = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_userGroupId??)>
<#if (where_and_eq_userGroupId_value??)>
${prefixName?string('WHERE ', 'AND ')}E.USER_GROUP_ID = :where_and_eq_userGroupId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.USER_GROUP_ID IS NULL OR E.USER_GROUP_ID = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_userGroupPermissionId??)>
<#if (where_and_eq_userGroupPermissionId_value??)>
${prefixName?string('WHERE ', 'AND ')}E.USER_GROUP_PERMISSION_ID = :where_and_eq_userGroupPermissionId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.USER_GROUP_PERMISSION_ID IS NULL OR E.USER_GROUP_PERMISSION_ID = '')
</#if>
<#assign prefixName = false>
</#if>
