...
<#if (insert_tokenInfoCode??) && (insert_tokenInfoCode_value??)>
...
<#if (insert_clientId??) && (insert_clientId_value??)>
${prefixName?string('  ', ', ')}:insert_clientId_value
<#assign prefixName = false>
</#if>
<#if (insert_createdByCode??) && (insert_createdByCode_value??)>
...
<#if (insert_scope??) && (insert_scope_value??)>
${prefixName?string('  ', ', ')}:insert_scope_value
<#assign prefixName = false>
</#if>
<#if (insert_siteCode??) && (insert_siteCode_value??)>
...
<#if (insert_tokenInfoCode??) && (insert_tokenInfoCode_value??)>
${prefixName?string('  ', ', ')}:insert_tokenInfoCode_value
<#assign prefixName = false>
</#if>
<#if (insert_tokenInfoId??) && (insert_tokenInfoId_value??)>
${prefixName?string('  ', ', ')}:insert_tokenInfoId_value
<#assign prefixName = false>
</#if>
<#if (insert_userCode??) && (insert_userCode_value??)>
...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM C1_TOKEN_INFO E
<#assign prefixName = true>
...
${prefixName?string('WHERE ', 'AND ')}E.CLIENT_ID = :where_and_eq_clientId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.CLIENT_ID IS NULL OR E.CLIENT_ID = '')
</#if>
<#assign prefixName = false>
</#if>
...
${prefixName?string('WHERE ', 'AND ')}E.SCOPE = :where_and_eq_scope_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.SCOPE IS NULL OR E.SCOPE = '')
</#if>
<#assign prefixName = false>
</#if>
...
${prefixName?string('WHERE ', 'AND ')}E.TOKEN_INFO_CODE = :where_and_eq_tokenInfoCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.TOKEN_INFO_CODE IS NULL OR E.TOKEN_INFO_CODE = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_tokenInfoId??)>
<#if (where_and_eq_tokenInfoId_value??)>
${prefixName?string('WHERE ', 'AND ')}E.TOKEN_INFO_ID = :where_and_eq_tokenInfoId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.TOKEN_INFO_ID IS NULL OR E.TOKEN_INFO_ID = '')
</#if>
<#assign prefixName = false>
</#if>
