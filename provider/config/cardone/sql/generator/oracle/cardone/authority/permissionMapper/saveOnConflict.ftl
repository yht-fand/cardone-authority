...
<#if (index_mapperCode??)>
${prefixName?string('', ', ')} :index_mapperCode_value AS MAPPER_CODE
<#assign prefixName = false>
</#if>
<#if (index_orderBy??)>
...
${prefixName?string('', ', ')} :index_permissionMapperId_value AS PERMISSION_MAPPER_ID
<#assign prefixName = false>
</#if>
...
<#if (index_mapperCode??)>
${prefixName?string('', 'AND ')}A.MAPPER_CODE = B.MAPPER_CODE
<#assign prefixName = false>
</#if>
<#if (index_orderBy??)>
...
<#if (index_permissionMapperId??)>
${prefixName?string('', 'AND ')}A.PERMISSION_MAPPER_ID = B.PERMISSION_MAPPER_ID
<#assign prefixName = false>
</#if>
<#if (index_personalCode??)>
