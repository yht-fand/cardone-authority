MERGE INTO C1_USER_GROUP_ROLE A USING
(SELECT
...
<#if (index_roleCode??)>
${prefixName?string('', 'AND ')} :index_roleCode_value AS ROLE_CODE
<#assign prefixName = false>
</#if>
<#if (index_roleId??)>
${prefixName?string('', 'AND ')} :index_roleId_value AS ROLE_ID
<#assign prefixName = false>
</#if>
<#if (index_siteCode??)>
...
${prefixName?string('', 'AND ')} :index_userGroupRoleId_value AS USER_GROUP_ROLE_ID
<#assign prefixName = false>
</#if>
<#if (index_version??)>
...
<#if (index_roleCode??)>
${prefixName?string('', ', ')}A.ROLE_CODE = B.ROLE_CODE
<#assign prefixName = false>
</#if>
<#if (index_roleId??)>
${prefixName?string('', ', ')}A.ROLE_ID = B.ROLE_ID
<#assign prefixName = false>
</#if>
<#if (index_siteCode??)>
...
<#if (index_userGroupRoleId??)>
${prefixName?string('', ', ')}A.USER_GROUP_ROLE_ID = B.USER_GROUP_ROLE_ID
<#assign prefixName = false>
</#if>
<#if (index_version??)>
...
<#if (update_roleCode??)>
${prefixName?string('', ', ')}A.ROLE_CODE = :update_roleCode_value
<#assign prefixName = false>
</#if>
<#if (update_roleId??)>
${prefixName?string('', ', ')}A.ROLE_ID = :update_roleId_value
<#assign prefixName = false>
</#if>
<#if (update_siteCode??)>
...
${prefixName?string('', ', ')}A.USER_GROUP_ROLE_ID = :update_userGroupRoleId_value
<#assign prefixName = false>
</#if>
<#if (update_version??)>
...
${prefixName?string('  ', ', ')}A.USER_GROUP_ROLE_ID
<#assign prefixName = false>
</#if>
...
<#if (insert_userGroupRoleId??) && (insert_userGroupRoleId_value??)>
${prefixName?string('  ', ', ')}:insert_userGroupRoleId_value
<#assign prefixName = false>
</#if>
<#if (insert_version??) && (insert_version_value??)>
