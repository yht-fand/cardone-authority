...
<#if (insert_mapperCode??) && (insert_mapperCode_value??)>
${prefixName?string('  ', ', ')}MAPPER_CODE
<#assign prefixName = false>
</#if>
...
<#if (insert_permissionMapperId??) && (insert_permissionMapperId_value??)>
${prefixName?string('  ', ', ')}PERMISSION_MAPPER_ID
<#assign prefixName = false>
</#if>
...
<#if (insert_mapperCode??) && (insert_mapperCode_value??)>
${prefixName?string('  ', ', ')}:insert_mapperCode_value
<#assign prefixName = false>
</#if>
<#if (insert_orderBy??) && (insert_orderBy_value??)>
...
<#if (insert_permissionMapperId??) && (insert_permissionMapperId_value??)>
${prefixName?string('  ', ', ')}:insert_permissionMapperId_value
<#assign prefixName = false>
</#if>
<#if (insert_personalCode??) && (insert_personalCode_value??)>
...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM C1_PERMISSION_MAPPER E
<#assign prefixName = true>
...
<#if (where_and_eq_mapperCode??)>
<#if (where_and_eq_mapperCode_value??)>
${prefixName?string('WHERE ', 'AND ')}E.MAPPER_CODE = :where_and_eq_mapperCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.MAPPER_CODE IS NULL OR E.MAPPER_CODE = '')
</#if>
<#assign prefixName = false>
</#if>
...
<#if (where_and_eq_permissionMapperId??)>
<#if (where_and_eq_permissionMapperId_value??)>
${prefixName?string('WHERE ', 'AND ')}E.PERMISSION_MAPPER_ID = :where_and_eq_permissionMapperId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.PERMISSION_MAPPER_ID IS NULL OR E.PERMISSION_MAPPER_ID = '')
</#if>
<#assign prefixName = false>
</#if>
