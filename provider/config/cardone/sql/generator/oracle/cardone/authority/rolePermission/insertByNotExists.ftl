...
${prefixName?string('  ', ', ')}ROLE_PERMISSION_ID
<#assign prefixName = false>
</#if>
...
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM C1_ROLE_PERMISSION E
<#assign prefixName = true>
...
${prefixName?string('WHERE ', 'AND ')}E.ROLE_CODE = :where_and_eq_roleCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.ROLE_CODE IS NULL OR E.ROLE_CODE = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_roleId??)>
<#if (where_and_eq_roleId_value??)>
${prefixName?string('WHERE ', 'AND ')}E.ROLE_ID = :where_and_eq_roleId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.ROLE_ID IS NULL OR E.ROLE_ID = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_rolePermissionId??)>
<#if (where_and_eq_rolePermissionId_value??)>
${prefixName?string('WHERE ', 'AND ')}E.ROLE_PERMISSION_ID = :where_and_eq_rolePermissionId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(E.ROLE_PERMISSION_ID IS NULL OR E.ROLE_PERMISSION_ID = '')
</#if>
<#assign prefixName = false>
</#if>
