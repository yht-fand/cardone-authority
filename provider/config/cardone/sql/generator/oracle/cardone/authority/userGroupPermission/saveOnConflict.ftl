MERGE INTO C1_USER_GROUP_PERMISSION A USING
(SELECT
...
${prefixName?string('', 'AND ')} :index_permissionCode_value AS PERMISSION_CODE
<#assign prefixName = false>
</#if>
<#if (index_permissionId??)>
${prefixName?string('', 'AND ')} :index_permissionId_value AS PERMISSION_ID
<#assign prefixName = false>
</#if>
...
${prefixName?string('', 'AND ')} :index_userGroupCode_value AS USER_GROUP_CODE
<#assign prefixName = false>
</#if>
<#if (index_userGroupId??)>
${prefixName?string('', 'AND ')} :index_userGroupId_value AS USER_GROUP_ID
<#assign prefixName = false>
</#if>
<#if (index_userGroupPermissionId??)>
${prefixName?string('', 'AND ')} :index_userGroupPermissionId_value AS USER_GROUP_PERMISSION_ID
<#assign prefixName = false>
</#if>
<#if (index_version??)>
...
<#if (index_userGroupCode??)>
${prefixName?string('', ', ')}A.USER_GROUP_CODE = B.USER_GROUP_CODE
<#assign prefixName = false>
</#if>
<#if (index_userGroupId??)>
${prefixName?string('', ', ')}A.USER_GROUP_ID = B.USER_GROUP_ID
<#assign prefixName = false>
</#if>
<#if (index_userGroupPermissionId??)>
${prefixName?string('', ', ')}A.USER_GROUP_PERMISSION_ID = B.USER_GROUP_PERMISSION_ID
<#assign prefixName = false>
</#if>
<#if (index_version??)>
...
<#if (update_userGroupPermissionId??)>
${prefixName?string('', ', ')}A.USER_GROUP_PERMISSION_ID = :update_userGroupPermissionId_value
<#assign prefixName = false>
</#if>
<#if (update_version??)>
...
${prefixName?string('  ', ', ')}A.USER_GROUP_PERMISSION_ID
<#assign prefixName = false>
</#if>
