...
<#if (index_userGroupUserId??)>
${prefixName?string('', 'AND ')} :index_userGroupUserId_value AS USER_GROUP_USER_ID
<#assign prefixName = false>
</#if>
<#if (index_userId??)>
...
<#if (index_userGroupUserId??)>
${prefixName?string('', ', ')}A.USER_GROUP_USER_ID = B.USER_GROUP_USER_ID
<#assign prefixName = false>
</#if>
<#if (index_userId??)>
