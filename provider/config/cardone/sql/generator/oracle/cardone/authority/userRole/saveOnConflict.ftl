MERGE INTO C1_USER_ROLE A USING
(SELECT
...
<#if (index_userRoleId??)>
${prefixName?string('', 'AND ')} :index_userRoleId_value AS USER_ROLE_ID
<#assign prefixName = false>
</#if>
<#if (index_version??)>
...
<#if (index_userRoleId??)>
${prefixName?string('', ', ')}A.USER_ROLE_ID = B.USER_ROLE_ID
<#assign prefixName = false>
</#if>
<#if (index_version??)>
...
<#if (update_userRoleId??)>
${prefixName?string('', ', ')}A.USER_ROLE_ID = :update_userRoleId_value
<#assign prefixName = false>
</#if>
<#if (update_version??)>
...
${prefixName?string('  ', ', ')}A.USER_ROLE_ID
<#assign prefixName = false>
</#if>
