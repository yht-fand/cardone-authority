...
${prefixName?string('WHERE ', 'AND ')}MAPPER_CODE = :where_and_eq_mapperCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(MAPPER_CODE IS NULL OR MAPPER_CODE = '')
</#if>
<#assign prefixName = false>
</#if>
...
${prefixName?string('WHERE ', 'AND ')}PERMISSION_CODE = :where_and_eq_permissionCode_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(PERMISSION_CODE IS NULL OR PERMISSION_CODE = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_permissionId??)>
<#if (where_and_eq_permissionId_value??)>
${prefixName?string('WHERE ', 'AND ')}PERMISSION_ID = :where_and_eq_permissionId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(PERMISSION_ID IS NULL OR PERMISSION_ID = '')
</#if>
<#assign prefixName = false>
</#if>
<#if (where_and_eq_permissionMapperId??)>
<#if (where_and_eq_permissionMapperId_value??)>
${prefixName?string('WHERE ', 'AND ')}PERMISSION_MAPPER_ID = :where_and_eq_permissionMapperId_value
<#else>
${prefixName?string('WHERE ', 'AND ')}(PERMISSION_MAPPER_ID IS NULL OR PERMISSION_MAPPER_ID = '')
</#if>
<#assign prefixName = false>
</#if>
