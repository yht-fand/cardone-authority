...
${prefixName?string('', 'AND ')} :index_clientSecret_value AS CLIENT_SECRET
<#assign prefixName = false>
</#if>
...
${prefixName?string('', 'AND ')} :index_oauthConsumerId_value AS OAUTH_CONSUMER_ID
<#assign prefixName = false>
</#if>
<#if (index_orderBy??)>
...
<#if (index_clientSecret??)>
${prefixName?string('', ', ')}A.CLIENT_SECRET = B.CLIENT_SECRET
<#assign prefixName = false>
</#if>
<#if (index_createdByCode??)>
...
<#if (index_oauthConsumerId??)>
${prefixName?string('', ', ')}A.OAUTH_CONSUMER_ID = B.OAUTH_CONSUMER_ID
<#assign prefixName = false>
</#if>
<#if (index_orderBy??)>
