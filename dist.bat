...
xcopy provider\target\cardone-authority-provider-*.jar dist\%1\provider /Y/C/R/I
...
xcopy consumer\target\cardone-authority-consumer-*.jar dist\%1\consumer /Y/C/R/I
