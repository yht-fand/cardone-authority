...
${prefixName} `ROLE_ID` = :where_and_eq_roleId_value
<#else>
${prefixName} `ROLE_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_nq_roleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_roleId_value??)>
${prefixName} `ROLE_ID` <> :where_and_nq_roleId_value
<#else>
${prefixName} `ROLE_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_roleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_roleId_value??)>
${prefixName} `ROLE_ID` <> :where_and_like_roleId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_roleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_roleId_value??)>
${prefixName} `ROLE_ID` = :where_or_eq_roleId_value
<#else>
${prefixName} `ROLE_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_roleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_roleId_value??)>
${prefixName} `ROLE_ID` <> :where_or_nq_roleId_value
<#else>
${prefixName} `ROLE_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_roleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_roleId_value??)>
${prefixName} `ROLE_ID` like :where_or_like_roleId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
