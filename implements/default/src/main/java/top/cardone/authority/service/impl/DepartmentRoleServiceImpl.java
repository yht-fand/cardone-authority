...
import top.cardone.authority.dao.DepartmentRoleDao;
...
public class DepartmentRoleServiceImpl extends PageServiceImpl<DepartmentRoleDao> implements top.cardone.authority.service.DepartmentRoleService {
    @Override
    ...
    public Map<String, Object> findOneByDepartmentRoleId(Object departmentRoleId) {
        return this.dao.findOneByDepartmentRoleId(departmentRoleId);
    }
}