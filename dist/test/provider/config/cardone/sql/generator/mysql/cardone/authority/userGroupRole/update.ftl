...
<#if (update_userGroupCode_value??)>
${prefixName} `USER_GROUP_CODE` = :update_userGroupCode_value
</#if>
<#assign prefixName = ','>
</#if>
<#if (update_userGroupRoleId??)>
<#if (update_userGroupRoleId_value??)>
${prefixName} `USER_GROUP_ROLE_ID` = :update_userGroupRoleId_value
</#if>
<#assign prefixName = ','>
</#if>
<#if (update_version??)>
