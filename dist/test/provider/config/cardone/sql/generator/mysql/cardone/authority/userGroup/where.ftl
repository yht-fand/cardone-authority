...
${prefixName} `USER_GROUP_ID` = :where_and_eq_userGroupId_value
<#else>
${prefixName} `USER_GROUP_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_nq_userGroupId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_userGroupId_value??)>
${prefixName} `USER_GROUP_ID` <> :where_and_nq_userGroupId_value
<#else>
${prefixName} `USER_GROUP_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_userGroupId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_userGroupId_value??)>
${prefixName} `USER_GROUP_ID` <> :where_and_like_userGroupId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_userGroupId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_userGroupId_value??)>
${prefixName} `USER_GROUP_ID` = :where_or_eq_userGroupId_value
<#else>
${prefixName} `USER_GROUP_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_userGroupId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_userGroupId_value??)>
${prefixName} `USER_GROUP_ID` <> :where_or_nq_userGroupId_value
<#else>
${prefixName} `USER_GROUP_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_userGroupId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_userGroupId_value??)>
${prefixName} `USER_GROUP_ID` like :where_or_like_userGroupId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
