...
xcopy provider\target\cardone-authority-provider-*.jar dist\test\provider /Y/C/R/I
...
xcopy consumer\target\cardone-authority-consumer-*.jar dist\test\consumer /Y/C/R/I
pause