...
<#if (where_and_eq_userRoleId??)>
<#if (where_and_eq_userRoleId_value??)>
${prefixName} `USER_ROLE_ID` = :where_and_eq_userRoleId_value
<#else>
${prefixName} `USER_ROLE_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_nq_userRoleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_userRoleId_value??)>
${prefixName} `USER_ROLE_ID` <> :where_and_nq_userRoleId_value
<#else>
${prefixName} `USER_ROLE_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_userRoleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_userRoleId_value??)>
${prefixName} `USER_ROLE_ID` <> :where_and_like_userRoleId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_userRoleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_userRoleId_value??)>
${prefixName} `USER_ROLE_ID` = :where_or_eq_userRoleId_value
<#else>
${prefixName} `USER_ROLE_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_userRoleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_userRoleId_value??)>
${prefixName} `USER_ROLE_ID` <> :where_or_nq_userRoleId_value
<#else>
${prefixName} `USER_ROLE_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_userRoleId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_userRoleId_value??)>
${prefixName} `USER_ROLE_ID` like :where_or_like_userRoleId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
