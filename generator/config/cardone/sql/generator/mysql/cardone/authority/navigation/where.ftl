...
<#if (where_and_nq_dataOption??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_dataOption_value??)>
...
<#if (where_and_like_dataOption??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_dataOption_value??)>
${prefixName} `DATA_OPTION` <> :where_and_like_dataOption_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_dataOption??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_dataOption_value??)>
${prefixName} `DATA_OPTION` = :where_or_eq_dataOption_value
<#else>
${prefixName} `DATA_OPTION` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_dataOption??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_dataOption_value??)>
${prefixName} `DATA_OPTION` <> :where_or_nq_dataOption_value
<#else>
${prefixName} `DATA_OPTION` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_dataOption??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_dataOption_value??)>
${prefixName} `DATA_OPTION` like :where_or_like_dataOption_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
<#if (where_and_nq_iconStyle??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_iconStyle_value??)>
...
<#if (where_and_like_iconStyle??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_iconStyle_value??)>
${prefixName} `ICON_STYLE` <> :where_and_like_iconStyle_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_iconStyle??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_iconStyle_value??)>
${prefixName} `ICON_STYLE` = :where_or_eq_iconStyle_value
<#else>
${prefixName} `ICON_STYLE` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_iconStyle??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_iconStyle_value??)>
${prefixName} `ICON_STYLE` <> :where_or_nq_iconStyle_value
<#else>
${prefixName} `ICON_STYLE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_iconStyle??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_iconStyle_value??)>
${prefixName} `ICON_STYLE` like :where_or_like_iconStyle_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
${prefixName} `NAVIGATION_CODE` = :where_and_eq_navigationCode_value
<#else>
${prefixName} `NAVIGATION_CODE` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_nq_navigationCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_navigationCode_value??)>
${prefixName} `NAVIGATION_CODE` <> :where_and_nq_navigationCode_value
<#else>
${prefixName} `NAVIGATION_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_navigationCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_navigationCode_value??)>
${prefixName} `NAVIGATION_CODE` <> :where_and_like_navigationCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_navigationCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_navigationCode_value??)>
${prefixName} `NAVIGATION_CODE` = :where_or_eq_navigationCode_value
<#else>
${prefixName} `NAVIGATION_CODE` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_navigationCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_navigationCode_value??)>
${prefixName} `NAVIGATION_CODE` <> :where_or_nq_navigationCode_value
<#else>
${prefixName} `NAVIGATION_CODE` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_navigationCode??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_navigationCode_value??)>
${prefixName} `NAVIGATION_CODE` like :where_or_like_navigationCode_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
${prefixName} `NAVIGATION_ID` = :where_and_eq_navigationId_value
<#else>
${prefixName} `NAVIGATION_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_nq_navigationId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_navigationId_value??)>
${prefixName} `NAVIGATION_ID` <> :where_and_nq_navigationId_value
<#else>
${prefixName} `NAVIGATION_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_navigationId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_navigationId_value??)>
${prefixName} `NAVIGATION_ID` <> :where_and_like_navigationId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_navigationId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_navigationId_value??)>
${prefixName} `NAVIGATION_ID` = :where_or_eq_navigationId_value
<#else>
${prefixName} `NAVIGATION_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_navigationId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_navigationId_value??)>
${prefixName} `NAVIGATION_ID` <> :where_or_nq_navigationId_value
<#else>
${prefixName} `NAVIGATION_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_navigationId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_navigationId_value??)>
${prefixName} `NAVIGATION_ID` like :where_or_like_navigationId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
<#if (where_and_nq_target??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_target_value??)>
...
<#if (where_and_like_target??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_target_value??)>
${prefixName} `TARGET` <> :where_and_like_target_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_target??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_target_value??)>
${prefixName} `TARGET` = :where_or_eq_target_value
<#else>
${prefixName} `TARGET` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_target??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_target_value??)>
${prefixName} `TARGET` <> :where_or_nq_target_value
<#else>
${prefixName} `TARGET` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_target??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_target_value??)>
${prefixName} `TARGET` like :where_or_like_target_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
...
<#if (where_and_like_url??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_url_value??)>
...
<#if (where_or_eq_url_value??)>
${prefixName} `URL` = :where_or_eq_url_value
<#else>
${prefixName} `URL` IS NULL
</#if>
<#assign prefixName = ''>
...
<#if (where_or_nq_url_value??)>
${prefixName} `URL` <> :where_or_nq_url_value
<#else>
${prefixName} `URL` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_url??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_url_value??)>
${prefixName} `URL` like :where_or_like_url_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
