package top.cardone.func.v1.authority.userGroupPermission;
...
public class ModifyModalFuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/v1/authority/userGroupPermission/modifyModal.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/v1/authority/userGroupPermission/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/v1/authority/userGroupPermission/ModifyModalFuncTest.func.output.json")
