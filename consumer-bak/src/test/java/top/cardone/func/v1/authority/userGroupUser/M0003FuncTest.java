...
public class M0003FuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/v1/authority/userGroupUser/m0003.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/v1/authority/userGroupUser/M0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/v1/authority/userGroupUser/M0003FuncTest.func.output.json")
