 ...
 */
@Controller
@RequestMapping("/v1/authority/rolePermission")
class RolePermissionController {
    ...
    Object c0001Json(HttpServletRequest request) {
        ApplicationContextHolder.getBean(WebSupport.class).func(request, { input -> ApplicationContextHolder.getBean(RolePermissionService.class).insertByNotExistsCache(input) })
    }
    /** /c0001.json end **/
}