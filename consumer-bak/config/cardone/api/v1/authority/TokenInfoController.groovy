 ...
 */
@Controller
@RequestMapping("/v1/authority/tokenInfo")
class TokenInfoController {
    ...
    Object c0001Json(HttpServletRequest request) {
        ApplicationContextHolder.getBean(WebSupport.class).func(request, { input -> ApplicationContextHolder.getBean(TokenInfoService.class).insertByNotExistsCache(input) })
    }
    /** /c0001.json end **/
}